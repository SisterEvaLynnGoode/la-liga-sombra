    ...
    <div className="min-h-screen bg-[#0c0e14]">
      ...
      <div className="print:hidden sticky top-0 z-20 border-b border-[rgba(201,147,58,0.2)] bg-[#111218] px-6 py-3 flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <a
            href="/teacher/worksheets/semana-2"
            className="px-4 py-2 font-typewriter text-[10px] tracking-[0.2em] uppercase border border-[rgba(201,147,58,0.35)] text-[#e8b455] hover:bg-[rgba(201,147,58,0.12)] transition-colors"
            title="Five more printable pages — origins, numbers, classroom objects"
          >
            📄 Semana 2 (no devices)
          </a>
          <a
            href="/teacher/worksheets/caso-3-vocabulario"
            className="px-4 py-2 font-typewriter text-[10px] tracking-[0.2em] uppercase border border-[rgba(201,147,58,0.35)] text-[#e8b455] hover:bg-[rgba(201,147,58,0.12)] transition-colors"
            title="Illustrated Madrid field guide + the Monday lost to Labor Day"
          >
            🗺️ Caso 3 · guía (4-day week)
          </a>
          <a
            href="/teacher/worksheets/caso-4-suplente"
            className="px-4 py-2 font-typewriter text-[10px] tracking-[0.2em] uppercase border border-[rgba(201,147,58,0.35)] text-[#e8b455] hover:bg-[rgba(201,147,58,0.12)] transition-colors"
            title="Sub plan + four student pages for the Monday you are out"
          >
            🧑‍🏫 Caso 4 · suplente
          </a>
          <button
