...
// Voice: male1 — the witness introduces himself as "el guardia... me llamo Rodolfo
//        Torres", so a female voice contradicted the script's own words. This clip
//        was never generated until now, so nothing depended on the old mismatch.
